...
% function mat2wav(rho,theta,gx,gy,gz,nomflip,ofname,desc,[hdrfloats,hdrints,addrframp,gsliceselect])
% Write waveforms to .wav file, use with toppe.e psd on GE scanners.
%
...
%
% $Id: mat2wav.m,v 1.13 2016/11/26 16:35:31 jfnielse Exp $
...
[rho,theta,gx,gy,gz] = sub_prepare_for_wavfile(rho,theta,gx,gy,gz,addrframp);
...
sub_writewav(ofname,desc,rho,theta,gx,gy,gz,paramsint16,paramsfloat);
...
function [rho,theta,gx,gy,gz] = sub_prepare_for_wavfile(rho,theta,gx,gy,gz,addrframp); %,tipupdelx,tipupdely)
